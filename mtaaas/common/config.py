...
"""
Routines for configuring Mtaaas
"""
...
from mtaaas.version import version_info as version
...
paste_deploy_opts = [
    cfg.StrOpt('flavor',
               help=_('Partial name of a pipeline in your paste configuration '
                      ...
                      '[pipeline:mtaaas-api-keystone] use the value '
                      '"keystone"')),
...
common_opts = [
    ...
    cfg.StrOpt('data_api', default='mtaaas.db.sqlalchemy.api',
...
CONF.import_opt('verbose', 'mtaaas.openstack.common.log')
CONF.import_opt('debug', 'mtaaas.openstack.common.log')
CONF.import_opt('log_dir', 'mtaaas.openstack.common.log')
CONF.import_opt('log_file', 'mtaaas.openstack.common.log')
CONF.import_opt('log_config', 'mtaaas.openstack.common.log')
CONF.import_opt('log_format', 'mtaaas.openstack.common.log')
CONF.import_opt('log_date_format', 'mtaaas.openstack.common.log')
CONF.import_opt('use_syslog', 'mtaaas.openstack.common.log')
CONF.import_opt('syslog_log_facility', 'mtaaas.openstack.common.log')
...
def parse_cache_args(args=None):
    config_files = cfg.find_config_files(project='mtaaas', prog='mtaaas-cache')
