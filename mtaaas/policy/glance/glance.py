...
from mtaaas.common import exception
import mtaaas.policy.glance.proxy
import mtaaas.openstack.common.log as logging
from mtaaas.openstack.common import policy
...
class Enforcer(object):
    ...
    def _check(self, context, rule, target, *args, **kwargs):
        """Verifies that the action is valid on the target in this context.
           ...
           :raises: `mtaaas.common.exception.Forbidden`
...
class ImageRepoProxy(mtaaas.policy.glance.proxy.Repo):
...
class ImageProxy(mtaaas.policy.glance.proxy.Image):
...
class ImageFactoryProxy(mtaaas.policy.glance.proxy.ImageFactory):
...
class ImageMemberFactoryProxy(mtaaas.policy.glance.proxy.ImageMembershipFactory):
...
class ImageMemberRepoProxy(mtaaas.policy.glance.proxy.Repo):
